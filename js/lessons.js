...
(function (global) {
  ...
  const LESSONS = [
    ...
    },
    {
      ...
      options: { noOpponent: true },
      hints: ['白子最后的一口气在它的正下方。', '在 (下方) 落子即可提掉白棋。'],
    ...
    },
    {
      ...
      options: { noOpponent: true },
      hints: ['两颗白子作为一个整体，只剩最下面 1 口气。', '在这串白棋的最下方落子。'],
    ...
    },
    {
      ...
      options: { noOpponent: true, showLiberties: [[4, 4]] },
      hints: ['向唯一的空口方向延伸。', '在黑子右侧落子，连出去就能多出几口气。'],
    ...
    /* ============ 第二章 · 吃子技巧 ============ */
    {
      ...
      goal: { type: 'atari', target: [4, 4] },
      options: { noOpponent: true },
      hints: ['白子还剩右侧和下方两口气，堵掉其中一口即可打吃。', '把白子往边角方向赶通常更有利。'],
    ...
    },
    {
      ...
      options: { noOpponent: true },
      hints: ['两颗白子之间的那个交叉点是要害。', '在 (4,4)——两白子正中间——落子。'],
    ...
    },
    {
      ...
      options: { noOpponent: true },
      hints: ['不要贴着白子打吃，那样它会一路逃。', '在白子的右下方斜方向 (4,4) 落子，罩住它。'],
    ...
    },
    {
      ...
      goal: { type: 'capture', target: [[4, 4]] },
      options: { noOpponent: true },
      hints: ['白子只剩左边一口气，在那里落子提掉它。', '提掉后你会发现白棋无法马上提回——这就是劫。'],
      success:
    ...
    /* ============ 第三章 · 死活基础 ============ */
    {
      ...
      intro:
        ...
        '上方这块黑棋已有一只眼（左边的 (2,0)），但右边还差一手才能成第二只眼。' +
        '请补上关键的一手，让它<strong>做出两只眼</strong>！',
      goal: { type: 'twoEyes', ref: [2, 1] },
      options: { noOpponent: true },
      hints: ['观察右上方的缺口，补上它就能围出第二只眼。', '在 (5,0) 落子，完成第二只眼。'],
    ...
    },
    {
      ...
      options: { noOpponent: true },
      hints: ['三个空点连成一排，要害在正中间。', '在 (3,0) 落子，点死白棋。'],
      success:
    ...
    },
    {
      ...
      goal: { type: 'twoEyes', ref: [2, 1] },
      options: { noOpponent: true },
      hints: ['中心点既是杀棋的要害，也是做活的要点。', '在 (3,0) 落子，分成两只眼。'],
